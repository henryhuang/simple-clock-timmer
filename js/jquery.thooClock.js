...
(function( $ ) {
    ...
    var setStartTime = function (current) {
        if (current) {
    ...
    $.fn.thooClock = function(options) {
       ...
       defaults = {
            ...
            $.fn.thooClock.reset = function(){
                setStartTime();
            };

            $.fn.thooClock.currentTime = function(){
                setStartTime(true);
            };
            ...
            function startClock(x){
                ...
                if (initialStartTime !== null) {
                    ...
                    startDate.setTime(initialStartTime)
                    theDate = startDate;
                    initialStartTime += 500
                } else {
                    theDate = new Date()
                }

                $("#time-digital").text(moment(theDate).format('HH:mm:ss'))
                ...
                setTimeout(function(){startClock(x)}, 500);
